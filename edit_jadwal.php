...
<?php
    ...
    error_reporting(0);
    if(!isset($_GET['id'])){
      header('Location: buat_jadwal.php');
    }else{
    ...
    $query_jadwal = mysqli_query($con, $sql_jadwal);
  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="ms-5">
        ...
        <a href="buat_jadwal.php" class="btn btn-primary ms-5 mb-2" type="submit">Add</a>
      </div>   
    ...
    <div id="elemen" style="position: absolute; display:block; width:700px; height:500px; margin-left:260px; margin-top:-470px;">
          <div id="elemen" class="alert alert-info alert-dismissible fade show" role="alert">
            ...
            <form action="" method="POST">           
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="nama_jadwal" placeholder="isi nama mahasiswa" value="<?= $jadwal['nama_jadwal']; ?>">
                    <input type="hidden" class="form-control" id="formGroupExampleInput2" name="id_jadwal" value="<?= $id_jadwal ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Dari Hari</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="hari_awal" placeholder="isi email mahasiswa" value="<?= $jadwal['hari_awal']; ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Ke Hari</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="hari_akhir" placeholder="isi hasil seleksi calon mahasiswa" value="<?= $jadwal['hari_akhir']; ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Tanggal Mulai</label>
                    <input type="date" class="form-control" id="formGroupExampleInput2" required name="tgl_mulai" value="<?= $jadwal['tgl_mulai']; ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Tanggal Selesai</label>
                    <input type="date" class="form-control" id="formGroupExampleInput2" required name="tgl_selesai" value="<?= $jadwal['tgl_selesai']; ?>">
                </div>
                <div class="d-flex">
                  <button class="btn btn-outline-warning me-1" type="submit" name="update">Update</button>
                </div>
                <?php
                  include "koneksi.php";
                  if(isset($_POST['update'])){
                    $id = $_POST['id_jadwal'];
                    $nama_jdwl = $_POST['nama_jadwal'];
                    $h_a = $_POST['hari_awal'];
                    $h_s = $_POST['hari_akhir'];
                    $tgl_a = $_POST['tgl_mulai'];
                    $tgl_s = $_POST['tgl_selesai'];
                      if(empty($id)){
                        echo "<script>alert('data tidak ditemukan');</script>";
                      }else{
                        $sql = "UPDATE jadwal SET nama_jadwal='$nama_jdwl', hari_awal='$h_a', hari_akhir='$h_s', tgl_mulai='$tgl_a', tgl_selesai='$tgl_s' WHERE id_jadwal='$id'";
                        $query = mysqli_query($con, $sql);
                        if($query){
                          echo "<script>alert('Berhasil di ubah');window.location='buat_jadwal.php';</script>";
                        }else{
