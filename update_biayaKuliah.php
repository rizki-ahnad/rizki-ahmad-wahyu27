    ...
    <div class="mt-3" style="margin-left:3px;">
      <div class="bg-secondary mb-1" style="width:1263px; height:8px;"></div>
        <div class="ms-5 mt-3 mb-3">
          <h3>Update Biaya Perkuliahan</h3>
        </div>
      </div>
      <div class="alert alert-info mt-1" role="alert">
        ...
        <tbody class="rounded">
              <tr bgcolor="#d83993" style="color:#ffffff;">
                ...
                <th style="width:350px;">Jenis Pembayaran</th>
                <th style="width:310px;">System Pembayaran</th>
                <th style="width:160px; text-align:center;">Jumlah Pembayaran</th>
                <th style="width:160px; text-align:center;">Aksi</th>
              </tr>
            <?php
                include "koneksi.php";
                error_reporting(0);
                $data_user= "SELECT * FROM biaya_kuliah";
                ...
                <tr bgcolor="#f27fc0">
                  ...
                  <td><?php echo $data['sistem']; ?></td>
                  <td style="text-align:center;"><?php echo $data['jumlah']; ?></td>
                  <td style="text-align:center;">
                    <a href="update_biayaKuliah.php?id=<?= $data['id_biaya'];?>" class="btn btn-light" type="submit" onclick="toggleElement()"><i class="bi bi-pencil-square"></i></a>
                  </td>
                  <?php
              include("koneksi.php");
              ...
              error_reporting(0);
              if(!isset($_GET['id'])){
                header('Location: update_biayaKuliah.php');
              }else{
              //ambil id dari query string
              $id_pegawai = $_GET['id'];

              // buat query untuk ambil data dari database
              $sql_seleksi = "SELECT * FROM biaya_kuliah WHERE id_biaya='$id_pegawai'";
          ...
          <div id="elemen" class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            <form action="" method="POST">           
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="jenis" value="<?= $pegawai['jenis']; ?>">
                    <input type="hidden" class="form-control" id="formGroupExampleInput2" required name="id_biaya" value="<?= $id_pegawai ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Sitem Pembayaran</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" name="sistem" value="<?= $pegawai['sistem']; ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Jumlah Pembayaran</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" name="jumlah" value="<?= $pegawai['jumlah']; ?>">
                </div>
                  ...
                  if(isset($_POST['update'])){
                    ...
                    $jumlah = $_POST['jumlah'];
                      if(empty($id)){
                        ...
                        $sql = "UPDATE biaya_kuliah SET jenis='$jenis1', sistem='$sistem', jumlah='$jumlah' WHERE id_biaya='$id'";
                        $query = mysqli_query($con, $sql);
                        if($query){
                          echo "<script>alert('Berhasil di ubah');window.location='update_biayaKuliah.php';</script>";
                        }else{
