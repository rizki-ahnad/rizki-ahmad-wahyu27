...
<main>
  ...
  <div class="d-block">
    ...
    <div style="margin-left:3px;">
      <div class="bg-secondary mt-2" style="width:1263px; height:8px;"></div>
      <div class="mt-5 mb-5">
        <center><h3>Dahsboard Admin</h3></center>
      </div>
      <div class="container">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-warning rounded-top"><center><a href="setting.php" class="text-white"><i class="bi bi-gear"></i> <b>Setting</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-success rounded-top"><center><a href="qrcode.php" class="text-white"><i class="bi bi-geo-alt"></i><b>Buat QRCode Maps</b></a></center></div>
          </div>
      </div>
      <div class="mt-3">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-primary rounded-top"><center><a href="password.php" class="text-white" style="width:35px; height:35px;"><i class="bi bi-key" style="width:35px; height:35px;"></i> <b>Ubah Password</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-danger rounded-top"><center><a href="buat_jadwal.php" class="text-white"><i class="bi bi-calendar-check"></i><b>  Buat Jadwal</b></a></center></div>
          </div>
      </div>
      <div class="mt-3">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-info rounded-top"><center><a href="pegawai.php" class="text-white"><i class="bi bi-people"></i><b> Data Pegawai</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-secondary rounded-top"><center><a href="soal.php" class="text-white"><i class="bi bi-card-text"></i><b> Soal Seleksi</b></a></center></div>
          </div>
      </div>
      <div class="mt-3">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-dark rounded-top"><center><a href="data_pendaftaran.php" class="text-white"><i class="bi bi-clipboard-data"></i></i><b> Data Pendaftaran</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-primary rounded-top"><center><a href="data_mahasiswa.php" class="text-white"><i class="bi bi-clipboard2-data"></i><b> Data Mahasiswa</b></a></center></div>
          </div>
      </div>
      <div class="mt-3">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-secondary rounded-top"><center><a href="daftar_ulang.php" class="text-white"><i class="bi bi-clipboard-plus"></i><b> Daftar Ulang</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-success rounded-top"><center><a href="bayar_daftarUlang.php" class="text-white"><i class="bi bi-cash-coin"></i><b> Saldo Daftar Ulang</b></a></center></div>
          </div>
      </div>
</div>
