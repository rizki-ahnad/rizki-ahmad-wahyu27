      ...
      <div class="container align-items-center p-2" style="width: 350px;">
        <div class="card">
            <div class="card-body">
              ...
              <div class="mb-3">
                <center>
                  <img src="gambar/<?= $poto; ?>" alt="profile" class="rounded-circle img-fluid" style="width:120px; height:120px;">
                </center>
              </div>
              <fieldset>
              <form action="" method="POST" enctype="multipart/form-data">
               ...
               <table>
                <tr>
                    <td style="width:350px;">Nama Lengkap</td>
                ...
                <tr>
                    ...
                    <td style="width:30px;"></td>
                    <td><a href="edit_direktur.php" class="btn btn-outline-secondary me-2 mt-3">Edit Akun</a></td>
                </tr>
            </table>
               </center>
            </div>
          ...
          if (isset($_POST['upload'])){
            ...
            if($tipe_file == "image/jpeg" || $tipe_file == "image/png" || $tipe_file == "image/jpg" || $tipe_file == "image/bmp" || $tipe_file == "image/gif"){ // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
                ...
                if($ukuran_file <= 3000000){ // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
                    ...
                    if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
                        ...
                        // Proses simpan ke Database
                            ...
                            if($cek > 0){
                                ...
                                echo "<script>alert('Berhasil Ganti Profile!');window.location.href='profile_direktur.php'</script>";
                            }else{
                    ...
                    echo "<script>alert('ukuran gambar terlalu besar!');window.location.href='profile_direktur.php'</script>";
                    }
            }else{
                // Jika tipe file yang diupload bukan JPG / JPEG / PNG, lakukan :
                echo "<script>alert('maaf format gambar tidak sesuai!');window.location.href='profile_direktur.php'</script>";
            }
          }
        ?>
</main>
