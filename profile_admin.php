              ...
              <form action="" method="POST" enctype="multipart/form-data">
               ...
               <table>
                ...
                <tr>
                    ...
                    <td style="width:30px;"></td>
                    <td><a href="edit_admin.php" class="btn btn-primary me-2 mt-3">Edit Akun</a></td>
                </tr>
            </table>
               </center>
            </div>
          ...
          if (isset($_POST['upload'])){
            ...
            if($tipe_file == "image/jpeg" || $tipe_file == "image/png" || $tipe_file == "image/jpg" || $tipe_file == "image/bmp" || $tipe_file == "image/gif"){ // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
                ...
                if($ukuran_file <= 3000000){ // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
                    ...
                    if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
                        ...
                        // Proses simpan ke Database
                            ...
                            if($cek > 0){
                                ...
                                echo "<script>alert('Berhasil Ganti Profile!');window.location.href='profile_admin.php'</script>";
                            }else{
                    ...
                    echo "<script>alert('ukuran gambar terlalu besar!');window.location.href='profile_admin.php'</script>";
                    }
            }else{
                // Jika tipe file yang diupload bukan JPG / JPEG / PNG, lakukan :
                echo "<script>alert('maaf format gambar tidak sesuai!');window.location.href='profile_admin.php'</script>";
            }
          }
        ?>
</main>
