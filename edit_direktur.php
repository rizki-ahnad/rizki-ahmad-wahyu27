...
<main>
  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="container align-items-center p-2" style="width: 550px;">
        <div class="card">
            <div class="card-body">
              <p class="card-title text-center"><b>Profile Direktur</b></p>
              <div class="mb-3">
                <center>
                  <img src="gambar/<?= $poto; ?>" alt="profile" class="rounded-circle" style="width:120px; height:120px;">
                </center>
              </div>
               <center>
                <form action="" method="POST">
                    <table>
                        <tr>
                            ...
                            <td style="width:250px;"><input type="text" id="inputName" class="form-control" name="nama" required value="<?= $nama ?>"></td>
                        </tr>
                        <tr>
                            <td style="width:150px;">Email</td>
                            <td style="width:10px;">:</td>
                            <td style="width:250px;"><input type="email" id="inputEmail" class="form-control" name="email" required value="<?= $email ?>"></td>
                        </tr>
                        <tr>
                            <td style="width:150px;">No Hp</td>
                            <td style="width:10px;">:</td>
                            <td style="width:250px;"><input type="number" id="inputNumber" class="form-control" name="nohp" required value="<?= $nohp ?>"></td>
                        </tr>
                        <tr>
                            <td style="width:150px;"></td>
                            <td style="width:30px;"></td>
                            <td><button class="btn btn-primary" name="ubah" type="submit" id="inputGroupFileAddon04">Ubah</button></td>
                        </tr>
                    </table>
                </form>
               </center>
...
<?php
          ...
          if (isset($_POST['ubah'])){
              ...
              $sql_p = "UPDATE user SET nama='$n1', email='$n2', nohp='$n3' WHERE id_user='$id'";
                $ubah_p = mysqli_query($con, $sql_p); 
              if($ubah_p){
                  echo "<script>alert('data user berhasil diubah');window.location.href='profile_direktur.php';</script>";
              }else{
