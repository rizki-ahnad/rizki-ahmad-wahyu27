  ...
  <body>
    <div class="container">
            <div style="display:flex;">
                ...
                <center>
                <p style="font-size:18px;"><b> DATA PENDAFTARAN CALON MAHASISWA <br>
                    AMIK PURNAMA NIAGA INDRAMAYU<br>
                    TAHUN AJARAN <?php echo date('Y')?> <br></b> 
                    Jalan Ir. H. Djuanda No. 256 Singaraja Indramayu
                </p>
                </center>
                </div>
            </div>
        ...
        <hr style="margin-top:2px;">
            ...
            <table border="1" width="99%" style="margin-left:5px;">
                    ...
                    <?php 
                        ...
                        // if(!isset($_GET['cari']) && !isset($_GET['ke'])){
                        ...
                        if($ke && $dari){ 
                            ...
                            $data = mysqli_query($con,"SELECT * FROM pendaftaran WHERE tanggal BETWEEN '".$dari."' and '".$ke."'");
                        }
                        if($cari){
                            $data = mysqli_query($con,"SELECT * FROM pendaftaran WHERE nama like '%".$cari."%' OR nisn like '%".$cari."%' OR kelas like '%".$cari."%' OR tanggal like '%".$cari."%' OR nomor_daftar like '%".$cari."%'");    
                        }
