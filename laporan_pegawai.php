  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="alert alert-dark mt-2 d-flex p-3" role="alert">
        <form action="laporan_pegawai.php" method="get">
      ...
      <div class="alert alert-info mt-1" role="alert">
        ...
        <tbody class="rounded">
              <tr bgcolor="#d83993" style="color:#ffffff;">
                <th style="width:60px; text-align:center;">No</th>
                <th style="width:350px;">Nama Pegawai</th>
                <th style="width:350px;">Email</th>
                <th style="width:350px;">No Hp</th>
            ...
            <?php
                ...
                if(isset($_POST['cari'])){
                    ...
                    $hasil = mysqli_query($con, $data_user);
                      ...
                      $data_user= "SELECT * FROM pegawai";
                      $hasil = mysqli_query($con, $data_user);
                      echo "<script>window.location='laporan_pegawai.php';</script>";
                  }else{
