  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="alert alert-dark mt-2 d-flex p-3" role="alert">
        <form action="laporan_mahasiswa.php" method="get">
      ...
      <div class="alert alert-info mt-1" role="alert">
        ...
        <tbody class="rounded">
              <tr bgcolor="#a31f1f" style="color:#ffffff;">
                ...
                <th style="width:150px; text-align:center;">Semester</th>
            ...
            <?php
                ...
                if(isset($_POST['cari'])){
                    ...
                    $hasil = mysqli_query($con, $data_user);
                      ...
                      $data_user= "SELECT * FROM daftar_ulang";
                      $hasil = mysqli_query($con, $data_user);
                      echo "<script>window.location='laporan_mahasiswa.php';</script>";
                  }else{
