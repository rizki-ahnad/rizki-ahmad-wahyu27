...
?>
 <?php
    ...
    $sql_soal = "SELECT * FROM soal_seleksi WHERE id_soal='$id_soal'";
    $query_soal = mysqli_query($con, $sql_soal);
    $soal = mysqli_fetch_assoc($query_soal);
  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="ms-5">
        ...
        <a href="soal.php" class="btn btn-primary ms-5 mb-2" type="submit"><i class="bi bi-card-text"></i> Add</a>
      </div>   
          ...
          <div id="elemen" class="alert alert-info alert-dismissible fade show" role="alert">
            ...
            <form action="" method="POST">           
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput2" required name="soal" value="<?= $soal['soal'] ?>">
                        <input type="hidden" class="form-control" id="formGroupExampleInput2" name="id_soal" value="<?= $id_soal ?>">
                    </div>
                    <div class="d-flex">
                        <div class="mb-3">
                            <label for="formGroupExampleInput2" class="form-label">Jawab A</label>
                            <input type="text" class="form-control" id="formGroupExampleInput2" required name="a" value="<?= $soal['a'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput2" class="form-label">Jawab B</label>
                            <input type="text" class="form-control" id="formGroupExampleInput2" required name="b" value="<?= $soal['b'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput2" class="form-label">Jawab C</label>
                            <input type="text" class="form-control" id="formGroupExampleInput2" required name="c" value="<?= $soal['c'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput2" class="form-label">Jawab D</label>
                            <input type="text" class="form-control" id="formGroupExampleInput2" required name="d" value="<?= $soal['d'] ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                  ...
                  if(isset($_POST['update'])){
                    ...
                    $kunci = $_POST['kunci'];
                      ...
                      if(empty($id)){
                        ...
                        $sql = "UPDATE soal_seleksi SET soal='$soal', a='$a', b='$b', c='$c', d='$d', kunci='$kunci' WHERE id_soal='$id'";
                        $query = mysqli_query($con, $sql);
                        if($query){
                          echo "<script>alert('Berhasil di ubah');window.location='soal.php';</script>";
                        }else{
