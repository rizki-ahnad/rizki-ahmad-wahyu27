  ...
  <body>
    <div class="container">
            <div style="display:flex;">
                ...
                <center>
                <p style="font-size:18px;"><b> DATA PEMBAYARAN PENDAFTARAN ONLINE <br>
        ...
        <hr style="margin-top:2px;">
            ...
            <table border="1" width="99%" style="margin-left:5px;">
                    ...
                    error_reporting(0);
                        ...
                        if(!isset($_GET['ke'])){
                            header('Location: lap_pembayaran.php');
                        }
                        ...
                        if($ke && $dari){ 
                            ...
                            $data = mysqli_query($con,"SELECT * FROM kode_akses WHERE tanggal BETWEEN '".$dari."' and '".$ke."'");
                        }else{
                            $data = mysqli_query($con,"SELECT * FROM kode_akses");		
                        }
                        // $no digunakan sebagai penomoran 
                        $no = 1;
                        // while digunakan sebagai perulangan data 
                        while($d = mysqli_fetch_array($data)){
                            $bayar[] = $d['bayar_daftar'];
                        ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                        ...
                        <tr>
                            ...
                            <td style="border-right:1px solid #fff"></td>
                            <td>Total:</td>
                            <td><?php error_reporting(0); $jumlah = array_sum($bayar); echo $jumlah; ?></td>
