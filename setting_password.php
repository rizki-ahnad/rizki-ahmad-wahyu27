    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="container">
          <div class="d-block ms-1">
              <center><h4 class="mb-4 mt-4">Form Update Password Pengguna</h4></center>
                <form action="" method="POST">
                    <div class="d-flex">
                            <div class="me-2" style="width:600px;">
                                    <div class="ms-5 mb-3">
                                        <label for="formGroupExampleInput2" class="form-label">Nama Lengkap</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput2" name="nama" placeholder="isi nama lengkap" disabled value="<?= $update['nama'];?>">
                                    </div>
                                    <div class="ms-5 mb-3">
                                        <label for="formGroupExampleInput2" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput2" name="email" placeholder="isi email" disabled value="<?= $update['email'];?>">
                                    </div>
                            </div>
                            <div class="me-3" style="width:600px;">
                                    <div class="ms-5 mb-3">
                                        <label for="formGroupExampleInput2" class="form-label">No WA (Aktif)</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput2" name="nohp" placeholder="isi nomor wa aktif" disabled  value="<?= $update['nohp'];?>">
                                    </div>
                                    <div class="ms-5 mb-3">
                                        <label for="formGroupExampleInput2" class="form-label">Update Password</label>
      ...
      <?php
        ...
        if(isset($_POST['simpan'])){
            ...
            $sql   = "UPDATE user SET password='$password' WHERE id_user='$id'";
              $query = mysqli_query($con, $sql);
              if($query){
                echo "<script>alert('Update Berhasil');window.location.href='password.php'</script>";
              }
              else{
