  ...
  <body>
    <div class="container">
            <div style="display:flex;">
                ...
                <center>
                <p style="font-size:18px;"><b> DATA HASIL SELEKSI ONLINE <br>
        ...
        <hr style="margin-top:2px;">
            ...
            <table border="1" width="99%" style="margin-left:5px;">
                    ...
                    <?php 
                        ...
                        if(!isset($_GET['ke'])){
                            header('Location: lap_seleksi.php');
                        }
                        ...
                        if($ke && $dari){ 
                            ...
                            $data = mysqli_query($con,"SELECT * FROM hasil_seleksi WHERE tanggal BETWEEN '".$dari."' and '".$ke."'");
                        }else{
                            $data = mysqli_query($con,"SELECT * FROM hasil_seleksi");		
                        }
