  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="alert alert-info mt-1" role="alert">
        ...
        <tbody class="rounded">
              <tr bgcolor="#a31f1f" style="color:#ffffff;">
            ...
            <?php
                include "koneksi.php";
                error_reporting(0);
                $data_user= "SELECT * FROM daftar_ulang";
                $hasil = mysqli_query($con, $data_user);
                $col = mysqli_num_rows($hasil);
                $no = 1;
                if(isset($_POST['cari'])){
                    $cari = $_POST['cari'];
                    $data_user= "SELECT * FROM daftar_ulang WHERE nama like '%".$cari."%' OR email like '%".$cari."%' OR kelas like '%".$cari."%' OR tanggal like '%".$cari."%' OR semester like '%".$cari."%'";
                    $hasil = mysqli_query($con, $data_user);
                ...
                <tr bgcolor="#fff">
                  ...
                  <td style="text-align:center;"><?php echo $data['program_studi']; ?></td>
                  <td style="text-align:center;"><?php echo $data['tanggal']; ?></td>
                  <td class="d-flex">
                    <a href="data_mahasiswa.php?id=<?= $data['id_daftar'];?>" class="btn btn-outline-danger" type="submit" onclick="toggleElement()"><i class="bi bi-pencil-square"></i></a>
                    <a href="lap_mahasiswa.php?cari=<?php if(isset($_POST['cari'])){echo $_POST['cari'];}?>" target="_blank" class="btn btn-outline-danger ms-1"><i class="bi bi-printer"></i></a>
                  </td>
                  <?php
              include("koneksi.php");
              ...
              $sql_mhs = "SELECT * FROM daftar_ulang WHERE id_daftar='$id_daftar'";
            ...
            <form action="" method="POST"> 
                <div class="d-flex">
                  ...
                  <div class="mb-3 me-2">
                      ...
                      <input type="text" class="form-control" id="formGroupExampleInput2" required name="kelas" value="<?= $mhs['kelas']; ?>">
                  </div>
                  <div class="mb-3 me-2">
                    <label for="formGroupExampleInput2" class="form-label">Semester</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="semester" value="<?= $mhs['semester']; ?>">
                  </div>
                  <div class="mb-3 me-2">
                    <label for="formGroupExampleInput2" class="form-label">No Hp</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="nohp" value="<?= $mhs['nohp']; ?>">
                  </div>
                </div>        
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Nama</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="nama" value="<?= $mhs['nama']; ?>">
                    <input type="hidden" class="form-control" id="formGroupExampleInput2" required name="id_daftar" placeholder="isi nama mahasiswa" value="<?= $id_daftar ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Email</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" required name="email" value="<?= $mhs['email']; ?>">
                </div>
                  ...
                  if(isset($_POST['update'])){
                    ...
                    $kelas = $_POST['kelas'];
                      if(empty($id1)){
                        ...
                        $sql = "UPDATE daftar_ulang SET nama='$nama1', email='$email1', nohp='$nohp1', semester='$semester1', kelas='$kelas' WHERE id_daftar='$id1'";
                        $query = mysqli_query($con, $sql);
                        if($query){
                          echo "<script>alert('Berhasil di ubah');window.location='data_mahasiswa.php';</script>";
                        }else{
