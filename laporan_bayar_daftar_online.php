  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="alert alert-dark mt-2 d-flex p-3" role="alert">
        <form action="laporan_bayar_daftar_online.php" method="get">
      ...
      <div class="alert alert-info mt-1" role="alert">
        ...
        <tbody class="rounded">
              <tr bgcolor="#63d230" style="color:#ffffff;">
            ...
            <?php
                ...
                if(isset($_POST['cari'])){
                    ...
                    $hasil = mysqli_query($con, $data_user);
                      ...
                      $data_user= "SELECT * FROM kode_akses";
                      $hasil = mysqli_query($con, $data_user);
                      echo "<script>window.location='laporan_bayar_daftar_online.php';</script>";
                  }else{
