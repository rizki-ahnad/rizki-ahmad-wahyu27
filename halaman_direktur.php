...
$lulus = "Lulus";
$data_mhs = mysqli_query($con,"SELECT * FROM hasil_seleksi WHERE status='$lulus'");
...
<main>
  ...
  <div class="d-block">
    ...
    <div style="margin-left:3px;">
      <div class="bg-secondary mt-3 mb-5" style="width:1263px; height:8px;"></div>
      <div class="mt-5 mb-5">
        <center><h3 class="mb-5">Dahsboard Direktur</h3></center>
      </div>
      <div class="container">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-warning rounded-top"><center><a href="laporan_mahasiswa.php" class="text-white"><i class="bi bi-clipboard-plus"></i> <b>Data Mahasiswa</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-success rounded-top"><center><a href="laporan_pendaftaran.php" class="text-white"><i class="bi bi-clipboard-plus"></i> <b>Data Pendaftar Online</b></a></center></div>
          </div>
      </div>
      <div class="mt-3">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-primary rounded-top"><center><a href="laporan_bayar_daftar_online.php" class="text-white" style="width:35px; height:35px;"><i class="bi bi-clipboard-plus"></i> <b>Data Pembayaran Daftar Online</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-danger rounded-top"><center><a href="laporan_daftar_ulang.php" class="text-white"><i class="bi bi-clipboard-plus"></i><b>  Data Pembayaran Daftar Ulang</b></a></center></div>
          </div>
      </div>
      <div class="mt-3">
        <div class="row">
          <div class="col">
          <div class="p-3 border bg-info rounded-top"><center><a href="laporan_pegawai.php" class="text-white"><i class="bi bi-clipboard-plus"></i><b> Data Pegawai</b></a></center></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-secondary rounded-top"><center><a href="laporan_seleksi.php" class="text-white"><i class="bi bi-clipboard-plus"></i><b> Data Hasil Seleksi</b></a></center></div>
          </div>
      </div>
</div>
