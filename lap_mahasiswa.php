  ...
  <body>
    <div class="container">
            <div style="display:flex;">
                ...
                <center>
                <p style="font-size:18px;"><b> DATA MAHASISWA <br>
        ...
        <hr style="margin-top:2px;">
            ...
            <table border="1" width="99%" style="margin-left:5px;">
                    ...
                    <?php 
                        ...
                        if($cari){
                            $data = mysqli_query($con,"SELECT * FROM daftar_ulang WHERE nama like '%".$cari."%' OR email like '%".$cari."%' OR kelas like '%".$cari."%' OR tanggal like '%".$cari."%' OR semester like '%".$cari."%'");    
                        }
