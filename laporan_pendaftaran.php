  ...
  <div class="d-block">
    ...
    <div class="mt-3" style="margin-left:3px;">
      ...
      <div class="alert alert-dark mt-2 d-flex p-3" role="alert">
        <form action="laporan_pendaftaran.php" method="get">
        ...
        <tbody class="rounded">
              <tr bgcolor="#dbf435" style="color:#00000;">
                <th style="width:60px; text-align:center;">No</th>
                <th style="width:160px;">NISN</th>
                <th style="width:160px;">Nomor Daftar</th>
            ...
            <?php
                ...
                if(isset($_POST['cari'])){
                    ...
                    $hasil = mysqli_query($con, $data_user);
                      ...
                      $data_user= "SELECT * FROM pendaftaran";
                      $hasil = mysqli_query($con, $data_user);
                      echo "<script>window.location='laporan_pendaftaran.php';</script>";
                  }else{
